        ...
        <div className="relative h-full min-h-screen w-full bg-black text-white grid grid-cols-1 gap-4 md:grid-cols-3  place-items-start">
          {
                ...
                <div
    class="inline-block duration-700 h-16 w-16 bg-orange-200 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]"
    role="status">
    <span
